...
class SimclrV2Model(pl.LightningModule):
    def __init__(self, config):
        ...
        self.projection = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(config.model.projection_size * 4, config.model.projection_size * 4),
            nn.BatchNorm1d(config.mdoel.projection_size * 4),
            nn.ReLU(),
