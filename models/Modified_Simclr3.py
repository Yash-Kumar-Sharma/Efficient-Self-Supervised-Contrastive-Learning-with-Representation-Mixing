...
class Modified_Simclr3Model(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx): 
        ...
        loss = xent_loss(newEmbeddings, embeddings_transform)

        self.loss_metric.update(loss)
        pos_mean, neg_mean = Modified_Positive_Negative_Mean(x = embeddings, y = embeddings_transform, device = self.global_rank)
