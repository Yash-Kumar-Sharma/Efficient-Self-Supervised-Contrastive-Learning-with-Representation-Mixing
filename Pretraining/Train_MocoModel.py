...
import time
import config
from MocoModel import MocoModel
...
def Train_MocoModel():
    ...
    pretrained_filename = os.path.join(checkpoint_path, "MocoModel.ckpt")
    ...
    trainer = pl.Trainer(
        default_root_dir=os.path.join(checkpoint_path + "MocoModel"),
        strategy = strategy,
        #profiler = profiler,
        logger = logger,
