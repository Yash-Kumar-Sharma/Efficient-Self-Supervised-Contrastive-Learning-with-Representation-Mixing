...
def Train_SimclrModel():
    ...
    pretrained_filename = os.path.join(checkpoint_path, "SimclrModel.ckpt")
    ...
    trainer = pl.Trainer(
        default_root_dir=os.path.join(checkpoint_path + "SimclrModel"),
        strategy = strategy,
        #profiler = profiler,
        logger = logger,
