...
class TinyImagenet_DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        if(self.model_name == "Our"):
            print("Our Data")
            self.train_set = OurDataFromTinyImagenet(K=self.K,
                                     root = self.data_dir,
        ...
        if(self.model_name == "Simclr" or self.model_name =="SimclrV2" or
            ...
            print("Simclr Data")
            self.train_set = SimclrDataFromTinyImagenet(K=self.K,
                                     root = self.data_dir,
                                     transform = self.preprocess,
                                     data_list = self.data_list,
                                     ) 
        if(self.model_name == "Moco"):
            print("Moco Data")
            self.train_set = MocoDataFromTinyImagenet(root = self.data_dir,
                                     transform = self.preprocess,
                                     data_list = self.data_list,
                                     )
